...
public:
    ...
    explicit SymbolicFactor(Key j) : Base(KeyVector{j})
    {
    }

    /** Construct binary factor */
    SymbolicFactor(Key j1, Key j2) : Base(KeyVector{j1, j2})
    {
    }

    /** Construct ternary factor */
    SymbolicFactor(Key j1, Key j2, Key j3) : Base(KeyVector{j1, j2, j3})
    {
    }

    /** Construct 4-way factor */
    SymbolicFactor(Key j1, Key j2, Key j3, Key j4) : Base(KeyVector{j1, j2, j3, j4})
    {
    }

    /** Construct 5-way factor */
    SymbolicFactor(Key j1, Key j2, Key j3, Key j4, Key j5) : Base(KeyVector{j1, j2, j3, j4, j5})
    {
    }

    /** Construct 6-way factor */
    SymbolicFactor(Key j1, Key j2, Key j3, Key j4, Key j5, Key j6) : Base(KeyVector{j1, j2, j3, j4, j5, j6})
    {
    }
    ...
    /// print
    void print(const std::string&  s         = "SymbolicFactor",
    ...
    /// print only keys
    void printKeys(const std::string&  s         = "SymbolicFactor",
                   const KeyFormatter& formatter = DefaultKeyFormatter) const override
    {
