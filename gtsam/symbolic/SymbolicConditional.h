 ...
 * \nosubgrouping
 */
class GTSAM_EXPORT SymbolicConditional : public SymbolicFactor, public Conditional<SymbolicFactor, SymbolicConditional>
{
public:
    ...
    SymbolicConditional(Key j, Key parent1, Key parent2, Key parent3)
      : BaseFactor(j, parent1, parent2, parent3), BaseConditional(1)
    {
    }
