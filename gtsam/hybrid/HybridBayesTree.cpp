...
template class BayesTreeCliqueBase<HybridBayesTreeClique, HybridGaussianFactorGraph>;
...
HybridValues HybridBayesTree::optimize() const
{
    ...
    {
        throw std::runtime_error("HybridBayesTree root is not discrete-only. Please check elimination "
...
struct HybridAssignmentData
{
     ...
     */
    HybridAssignmentData(const DiscreteValues& assignment, const GaussianBayesTree::sharedNode& parentClique,
                         GaussianBayesTree* gbt, bool valid = true)
      : assignment_(assignment), parentClique_(parentClique), gaussianbayesTree_(gbt), valid_(valid)
    {
    }
     ...
     */
    static HybridAssignmentData AssignmentPreOrderVisitor(const HybridBayesTree::sharedNode& node,
                                                          HybridAssignmentData&              parentData)
    {
        ...
        HybridAssignmentData data(parentData.assignment_, clique, parentData.gaussianbayesTree_, parentData.valid_);
        return data;
    }
};
...
/* *************************************************************************
 */
GaussianBayesTree HybridBayesTree::choose(const DiscreteValues& assignment) const
{
    ...
    HybridAssignmentData rootData(assignment, 0, &gbt);
    {
        ...
        treeTraversal::DepthFirstForestParallel(*this, rootData, HybridAssignmentData::AssignmentPreOrderVisitor,
                                                visitorPost);
    }
...
void HybridBayesTree::prune(const size_t maxNrLeaves)
{
    ...
    struct HybridPrunerData
    {
        ...
        HybridPrunerData(const DecisionTreeFactor& prunedDecisionTree, const HybridBayesTree::sharedNode& parentClique)
         ...
         */
        static HybridPrunerData AssignmentPreOrderVisitor(const HybridBayesTree::sharedNode& clique,
