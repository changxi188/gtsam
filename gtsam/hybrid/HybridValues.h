...
public:
    ...
    HybridValues(const VectorValues& cv, const DiscreteValues& dv) : continuous_(cv), discrete_(dv){};
    ...
    {
        return continuous_.equals(other.continuous_, tol) && discrete_.equals(other.discrete_, tol);
    }
