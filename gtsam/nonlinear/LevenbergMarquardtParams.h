...
public:
    ...
    VerbosityLM verbosityLM;  ///< The verbosity level for Levenberg-Marquardt (default: SILENT), see also
    ...
    LevenbergMarquardtParams() : verbosityLM(SILENT), diagonalDamping(false), minDiagonal(1e-6), maxDiagonal(1e32)
    {
