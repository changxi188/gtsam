 ...
 * @ingroup navigation
 */
class GTSAM_EXPORT ImuFactor : public NoiseModelFactorN<Pose3, Vector3, Pose3, Vector3, imuBias::ConstantBias>
{
private:
...
public:
    ...
    Vector evaluateError(const Pose3& pose_i, const Vector3& vel_i, const Pose3& pose_j, const Vector3& vel_j,
                         const imuBias::ConstantBias& bias_i, boost::optional<Matrix&> H1 = boost::none,
    ...
    static PreintegratedImuMeasurements Merge(const PreintegratedImuMeasurements& pim01,
...
private:
    ...
    void serialize(ARCHIVE& ar, const unsigned int /*version*/)
    {
        ...
        ar& boost::serialization::make_nvp("NoiseModelFactor5", boost::serialization::base_object<Base>(*this));
...
private:
    ...
    void serialize(ARCHIVE& ar, const unsigned int /*version*/)
    {
        ...
        ar& boost::serialization::make_nvp("NoiseModelFactor3", boost::serialization::base_object<Base>(*this));
        ar& BOOST_SERIALIZATION_NVP(_PIM_);
    }
};
// class ImuFactor2
