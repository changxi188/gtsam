...
public:
    ...
    {
        BOOST_STATIC_ASSERT_MSG((boost::is_base_of<group_tag, structure_category_tag>::value),
...
struct MultiplicativeGroupTraits
{
    ...
    static Class Compose(const Class& g, const Class& h)
    {
        return g * h;
    }
    ...
    static Class Inverse(const Class& g)
    {
        return g.inverse();
    }
};
...
template <typename G, typename H>
struct traits<DirectProduct<G, H> > : internal::MultiplicativeGroupTraits<DirectProduct<G, H> >
{
};
