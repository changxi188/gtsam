...
{
    Symmetric(const Eigen::PermutationMatrix<N>& P) : Eigen::PermutationMatrix<N>(P)
    {
    }
...
template <int N>
struct traits<Symmetric<N> > : internal::MultiplicativeGroupTraits<Symmetric<N> >, Testable<Symmetric<N> >
{
};
...
TEST(Group, Dih6)
{
    Dih6 e, g(S2::Transposition(0, 1), S3::Transposition(0, 1) * S3::Transposition(1, 2));
