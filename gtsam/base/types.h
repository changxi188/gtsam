...
#ifdef __clang__
#define CLANG_DIAGNOSTIC_PUSH_IGNORE(diag) _Pragma("clang diagnostic push") DO_PRAGMA(clang diagnostic ignored diag)
#else
#define CLANG_DIAGNOSTIC_PUSH_IGNORE(diag)
#endif

#ifdef __GNUC__
#define GCC_DIAGNOSTIC_PUSH_IGNORE(diag) _Pragma("GCC diagnostic push") DO_PRAGMA(GCC diagnostic ignored diag)
#else
#define GCC_DIAGNOSTIC_PUSH_IGNORE(diag)
#endif

#ifdef _MSC_VER
#define MSVC_DIAGNOSTIC_PUSH_IGNORE(code) _Pragma("warning ( push )") DO_PRAGMA(warning(disable : code))
#else
...
#pragma clang diagnostic ignored                                                                                       \
    "-Wunused-private-field"  // Clang complains that previousOpenMPThreads is unused in the #else case below
#endif
