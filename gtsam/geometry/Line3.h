 ...
 */
GTSAM_EXPORT Line3 transformTo(const Pose3& wTc, const Line3& wL, OptionalJacobian<4, 6> Dpose = boost::none,
...
public:
    ...
    Line3(const Rot3& R, const double a, const double b) : R_(R), a_(a), b_(b)
    {
    }
     ...
     */
    Line3 retract(const Vector4& v, OptionalJacobian<4, 4> Dp = boost::none,
     ...
     */
    Vector4 localCoordinates(const Line3& q, OptionalJacobian<4, 4> Dp = boost::none,
     ...
     * @return Transformed line in camera frame
     */
    friend Line3 transformTo(const Pose3& wTc, const Line3& wL, OptionalJacobian<4, 6> Dpose,
