...
/* ************************************************************************* */
OrientedPlane3 OrientedPlane3::transform(const Pose3& xr, OptionalJacobian<3, 3> Hp, OptionalJacobian<3, 6> Hr) const
{
                                    ...
                                    OptionalJacobian<3, 3> H2) const
{
    ...
    Vector2  n_error = n_.errorVector(other.n_, H1 ? &H_n_error_this : 0, H2 ? &H_n_error_other : 0);
...
/* ************************************************************************* */
OrientedPlane3 OrientedPlane3::retract(const Vector3& v, OptionalJacobian<3, 3> H) const
{
    Matrix22 H_n;
