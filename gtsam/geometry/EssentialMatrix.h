...
public:
    ...
    EssentialMatrix(const Rot3& aRb, const Unit3& aTb) : R_(aRb), t_(aTb), E_(t_.skew() * R_.matrix())
    {
    }
    ...
    GTSAM_EXPORT static EssentialMatrix FromPose3(const Pose3& _1P2_, OptionalJacobian<5, 6> H = boost::none);
     ...
     */
    GTSAM_EXPORT Point3 transformTo(const Point3& p, OptionalJacobian<3, 5> DE = boost::none,
     ...
     */
    GTSAM_EXPORT EssentialMatrix rotate(const Rot3& cRb, OptionalJacobian<5, 5> HE = boost::none,
