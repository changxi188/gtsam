...
public:
    ...
    Pose2() : r_(traits<Rot2>::Identity()), t_(traits<Point2>::Identity())
    {
    }
     ...
     */
    Pose2(double x, double y, double theta) : r_(Rot2::fromAngle(theta)), t_(x, y)
    {
    }

    /** construct from rotation and translation */
    Pose2(double theta, const Point2& t) : r_(Rot2::fromAngle(theta)), t_(t)
    {
    }
    ...
    Pose2(const Matrix& T) : r_(Rot2::atan2(T(1, 0), T(0, 0))), t_(T(0, 2), T(1, 2))
    {
    ...
    GTSAM_EXPORT Point2 transformTo(const Point2& point, OptionalJacobian<2, 3> Dpose = boost::none,
    ...
    GTSAM_EXPORT Point2 transformFrom(const Point2& point, OptionalJacobian<2, 3> Dpose = boost::none,
                                      OptionalJacobian<2, 2> Dpoint = boost::none) const;
    ...
    /// translation
    inline const Point2& translation() const
    {
        return t_;
    }
     ...
     */
    GTSAM_EXPORT Rot2 bearing(const Point2& point, OptionalJacobian<1, 3> H1 = boost::none,
     ...
     * @return 2D rotation \f$ \in SO(2) \f$
     */
    GTSAM_EXPORT Rot2 bearing(const Pose2& pose, OptionalJacobian<1, 3> H1 = boost::none,
     ...
     * @return range (double)
     */
    GTSAM_EXPORT double range(const Point2& point, OptionalJacobian<1, 3> H1 = boost::none,
                              OptionalJacobian<1, 2> H2 = boost::none) const;
     ...
     * @return range (double)
     */
    GTSAM_EXPORT double range(const Pose2& point, OptionalJacobian<1, 3> H1 = boost::none,
                              OptionalJacobian<1, 3> H2 = boost::none) const;
 ...
 */
GTSAM_EXPORT boost::optional<Pose2> GTSAM_DEPRECATED align(const Point2Pairs& pairs);
#endif
