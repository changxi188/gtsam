...
void calibrateJacobians(const Cal& calibration, const Point2& pn, OptionalJacobian<2, Dim> Dcal = boost::none,
...
public:
    ...
    Cal3(double fx, double fy, double s, double u0, double v0) : fx_(fx), fy_(fy), s_(s), u0_(u0), v0_(v0)
    {
    }

    /// constructor from vector
    Cal3(const Vector5& d) : fx_(d(0)), fy_(d(1)), s_(d(2)), u0_(d(3)), v0_(d(4))
    {
    }
    ...
    Matrix3 GTSAM_DEPRECATED matrix() const
    {
        return K();
    }
#endif
