...
namespace gtsam
{
class GTSAM_EXPORT GaussianEliminationTree : public EliminationTree<GaussianBayesNet, GaussianFactorGraph>
{
public:
     ...
     */
    GaussianEliminationTree(const GaussianFactorGraph& factorGraph, const VariableIndex& structure,
