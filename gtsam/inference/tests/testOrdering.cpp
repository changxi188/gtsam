...
TEST(Ordering, csr_format)
{
    ...
    const vector<int> xadjExpected{0, 2, 5, 8, 11, 13, 16, 20, 24, 28, 31, 33, 36, 39, 42, 44},
        adjExpected{1, 5,  0, 2, 6, 1,  3, 7, 2,  4, 8,  3, 9,  0,  6, 10, 1,  5, 7,  11, 2, 6,
                    8, 12, 3, 7, 9, 13, 4, 8, 14, 5, 11, 6, 10, 12, 7, 11, 13, 8, 12, 14, 9, 13};
...
TEST(Ordering, csr_format_2)
{
    ...
    const std::vector<int> xadjExpected{0, 1, 4, 6, 8, 10}, adjExpected{1, 0, 2, 4, 1, 3, 2, 4, 1, 3};
...
TEST(Ordering, csr_format_4)
{
    ...
    const vector<int> xadjExpected{0, 1, 3, 5, 7, 9, 10}, adjExpected{1, 0, 2, 1, 3, 2, 4, 3, 5, 4};
