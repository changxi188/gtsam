...
struct EliminationData
{
    ...
    EliminationData(EliminationData* _parentData, size_t nChildren) : parentData(_parentData)
    {
...
/* ************************************************************************* */
template <class TREE>
EliminationData<TREE> eliminationPreOrderVisitor(const typename TREE::sharedNode& node,
                                                 EliminationData<TREE>&           parentData)
{
...
template <class TREE, class RESULT>
FastVector<typename TREE::sharedFactor> EliminateTree(RESULT& result, const TREE& tree,
