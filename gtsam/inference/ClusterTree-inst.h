...
void ClusterTree<GRAPH>::Cluster::print(const std::string& s, const KeyFormatter& keyFormatter) const
{
...
/* ************************************************************************* */
template <class GRAPH>
void ClusterTree<GRAPH>::Cluster::mergeChildren(const std::vector<bool>& merge)
{
...
struct EliminationData
{
    ...
    EliminationData(EliminationData* _parentData, size_t nChildren)
      ...
      , bayesTreeNode(boost::make_shared<BTNode>())
#ifdef GTSAM_USE_TBB
...
EliminatableClusterTree<BAYESTREE, GRAPH>& EliminatableClusterTree<BAYESTREE, GRAPH>::operator=(const This& other)
{
...
EliminatableClusterTree<BAYESTREE, GRAPH>::eliminate(const Eliminate& function) const
{
    ...
    typename Data::EliminationPostOrderVisitor visitorPost(function, result->nodes_);
    {
        ...
        treeTraversal::DepthFirstForestParallel(*this, rootsContainer, Data::EliminationPreOrderVisitor, visitorPost,
                                                10);
    }
